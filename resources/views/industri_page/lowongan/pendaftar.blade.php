...
@section('title',
    'Review Pendaftar: ' .
    (optional($pengajuan->mahasiswa)->nama_lengkap ?? 'Mahasiswa') .
    ' - Lowongan:
    ' .
    (optional($pengajuan->lowongan)->judul_lowongan ?? ''))
    ...
    @push('css')
        <style>
            ...
            .section-title-clean:first-of-type {
                margin-top: 0;
            }
...
@section('content')
    <div class="container-fluid py-3">
        <div class="row mb-3">
            <div class="col-12">
                @php
                    $backUrl = route('industri.lowongan.show', $pengajuan->lowongan_id);
                    $backText = 'Kembali ke Detail Lowongan';

                    // 2. Cek nilai parameter 'from' dari URL.
                    if (request('from') === 'dashboard') {
                        // Jika datang dari dashboard, arahkan kembali ke dashboard.
                        // Pastikan Anda memiliki route bernama 'industri.dashboard'.
                        $backUrl = route('home');
                        $backText = 'Kembali ke Dashboard';
                    }
                    // Jika 'from' adalah 'detail' atau lainnya, maka akan menggunakan nilai default di atas.
                @endphp
                ...
                <div class="profile-header-clean mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-2 text-center mb-3 mb-md-0">
                            <img src="{{ optional($pengajuan->mahasiswa)->foto ? asset('storage/mahasiswa/foto/' . $pengajuan->mahasiswa->foto) : asset('assets/default-profile.png') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 border-end-lg pe-lg-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="info-item">
                                    ...
                                    @php
                                        ...
                                        if ($org === 'aktif') {
                                            $orgText = 'Aktif';
                                        } elseif ($org === 'sangat_aktif') {
                                            $orgText = 'Sangat Aktif';
                                        }
                                    @endphp
                                    <span>{{ $orgText }}</span>
                                </div>
                                <div class="info-item">
                                    ...
                                    @php
                                        ...
                                        if ($lomba === 'aktif') {
                                            $lombaText = 'Pernah Ikut/Finalis';
                                        } elseif ($lomba === 'sangat_aktif') {
                                            $lombaText = 'Sering Ikut & Juara';
                                        }
                                    @endphp
                                    <span>{{ $lombaText }}</span>
                                </div>
                        ...
                        @if (!$validSkills || $validSkills->isEmpty())
                            <div class="alert alert-secondary text-center">Mahasiswa ini belum memiliki skill yang
                                tervalidasi.</div>
                        @else
                                ...
                                <div class="card detail-card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <h6 class="mb-0 me-2">
                                                {{ optional(optional($mahasiswaSkill)->detailSkill)->skill_nama ?? 'Skill tidak diketahui' }}
                                            </h6>
                                            <div>
                                                <span
                                ...
                                <ul class="list-group list-group-flush mb-3">
                                    @foreach ($pengajuan->lowongan->lowonganSkill as $lowSkill)
                                        <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                                            <span><i
                                                    class="fas fa-check-circle text-muted me-2"></i>{{ optional(optional($lowSkill)->skill)->skill_nama ?? 'N/A' }}</span>
                                            <span
