    ...
    <div class="card card-outline card-primary">
        <div class="card-body text-sm">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-center" id="table_logharian_dosen" style="width:100%">
                    <thead>
                        <tr>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const tableLogDosen = $('#table_logharian_dosen').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{{ route('logharian_dosen.list') }}',
                type: 'POST',
                data: function (d) {
        ...
        $('#filterNama').on('input', function () {
            tableLogDosen.ajax.reload(null, false);
        });
    });
</script>
@endpush