...
@section('title', 'Tambah Lowongan Baru oleh Admin')

@section('content')
    <div class="container-fluid">
        <a href="{{ route('lowongan.index') }}" class="btn btn-white btn-sm mb-3">
            ...
            <div class="col-md-12">
                <div class="card border-dark shadow-sm">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Formulir Tambah Lowongan Baru</h3>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('lowongan.store') }}" method="POST">
                            ...
                            {{-- PILIH INDUSTRI (KHUSUS ADMIN) --}}
                            <div class="form-group mb-3">
                                <label for="industri_id" class="form-label">Pilih Industri <span
                                        class="text-danger">*</span></label>
                                <select class="form-select @error('industri_id') is-invalid @enderror" id="industri_id"
                                    name="industri_id" required>
                                    <option value="">-- Pilih Industri Penyelenggara --</option>
                                    @foreach ($industriList as $industri)
                                        <option value="{{ $industri->industri_id }}"
                                            {{ old('industri_id') == $industri->industri_id ? 'selected' : '' }}>
