        ...
        @auth('web')
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="collapse"
                    data-bs-target="#dropdownMenuUser" aria-expanded="false" aria-controls="dropdownMenuUser">
            ...
            <li class="nav-item ">
                <a class="nav-link {{ $activeMenu == 'home' ? 'prodi' : '' }}" href="{{ route('program-studi.index') }} ">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled ps-4 {{ in_array($activeMenu, ['kategori_industri', 'industri']) ? 'show' : '' }}" id="dropdownMenuIndustri">
                    <ul class="collapse list-unstyled ps-4 {{ in_array($activeMenu, ['kategori_industri', 'industri']) ? 'show' : '' }}" id="dropdownMenuIndustri">
                        <li class="nav-item">
                            <a class="dropdown-item d-flex align-items-center py-2 border-bottom text-sm {{ $activeMenu == 'kategori_industri' ? 'active fw-bold' : '' }}" href="{{route('kategori-industri.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $activeMenu == 'detail_lowongan' ? 'active' : '' }}" href="{{ route('lowongan.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $activeMenu == 'pengajuan' ? 'active' : '' }}" href="{{ route('pengajuan.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="sidenav-footer mx-3">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      <div class="full-background" style="background-image: url('{{ asset('softTemplate/assets/img/curved-images/white-curved.jpg') }}')"></div>
